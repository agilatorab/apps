...
// links to the App Store, to itself, to the company site it belongs to, and to
// our own contact address, and that is the whole of it. Stating what is permitted keeps the rule short, makes an
...
import { COMPANY_SITE } from "../data/brand.js";
...
const ALLOWED = [
  ...
  (url) => url === COMPANY_SITE, // the company site this one belongs to
